            ...
            <div className='services__contenedor'>
                ...
                <div className='service__contenedorDivs'>
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/color__orange.png" alt="" />
                    ...
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/code__orange.png" alt="" />
                    ...
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/mining__orange.png" alt="" />
                    ...
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/automatic__orange.png" alt="" />
                    ...
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/phone__orange.png" alt="" />
                    ...
                    <div className='services__divService'>
                        <img src="../../../portafolio/img/data__orange.png" alt="" />
