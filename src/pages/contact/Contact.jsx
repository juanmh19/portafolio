        ...
        <section className='contact'>
            <div className='contact__contenedor'>
                ...
                <div className='contact__div contact__contacts'>
                    <div>
                        <img src="../../portafolio/public/img/iphone__orange.png" alt="" />
                        <p className='contact__contact'>Whatsapp</p>
                        <p>+54 11 3937-4067</p>
                    </div>
                    <div>
                        <img src="../../portafolio/public/img/email__orange.png" alt="" />
                        <p className='contact__contact'>Email</p>
                        <p>juanmhdev@gmail.com</p>
                    </div>
                    <div>
                        <img src="../../portafolio/public/img/linkedin__orange.png" alt="" />
