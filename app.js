...
about__profesionalmente.addEventListener("click", e=>{
    ...
    about__texto.textContent = "Soy un desarrollador web fullstack, en constante aprendizaje, principalmente estoy centrado en Javascript y Node, realice varios cursos y estoy estudiando ingenieria en software, intento afianzar mis conocimentos mediante proyectos y plasmar mi esencia en ellos."
...
about__personalmente.addEventListener("click", e=>{
    ...
    about__texto.textContent = "Me llamo Herner, Juan Manuel. Tengo 20 años y vivo en Buenos Aires. Siempre tuve una inexplicable pasión por la historia, economia, tecnologia e innovación, convirtiendose la programación en la predominante entre ellas, porque mezclaba 3 factores que siempre ame, la creación, innovación y la computadora."
    about__texto.style.animation ="desliz-derecha 3s"
    setTimeout(() => {
        about__texto.style.animation =""
    }, 1000);
